        ...
        <div className='container mx-auto' >
            ...
            <div data-aos="zoom-in">
                ...
                <div className='grid grid-cols-2 lg:grid-cols-4 gap-2 p-3'>
                    ...
                    <img className='rounded' data-aos="zoom-in" data-aos-duration="700" src="https://i.ibb.co/sR3hDSm/10.jpg" alt="" />
                    <img className='rounded' data-aos="zoom-in" data-aos-duration="900" src="https://i.ibb.co/yWTJtCV/11.jpg" alt="" />
                    <img className='rounded' data-aos="zoom-in" data-aos-duration="1100" src="https://i.ibb.co/WkBgMXh/16.jpg" alt="" />
                    <img className='rounded' data-aos="zoom-in" data-aos-duration="1300" src="https://i.ibb.co/X5VvXgM/17.jpg" alt="" />
